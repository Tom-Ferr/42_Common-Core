...
/*   Updated: 2021/04/14 10:09:48 by tde-cama         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	t_vec3 oc = vec_subtract(params->r.orig, obj->center);
    double a = length_squared(params->r.dir);
    double half_b = dot(oc, params->r.dir);
    double c = length_squared(oc) - (obj->radius * obj->radius);
